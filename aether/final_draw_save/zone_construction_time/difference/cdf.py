...
# 设置文件夹路径
file_path = '/home/matsu/final_v1.1/difference/construction_time_difference.csv'
...
print(f"90%: {difference_quantiles[0]/60000} ")
print(f"95%: {difference_quantiles[1]/60000} ")
print(f"99%: {difference_quantiles[2]/60000} ")
print(f"99.9%: {difference_quantiles[3]/60000} ")
...
sns.kdeplot(difference_log, cumulative=True, bw_adjust=0.05,label='Difference ', color='#FF7F00', linewidth=10,clip=(min_difference, max_difference))
...
plt.annotate(
    ...
    xytext=(max_difference -0.8, 0.85),
...
plt.xlabel('CDF of Construction Difference Time(ms)', fontsize=24, fontweight='bold')
...
# 保存图像
plt.tight_layout()
plt.savefig('/home/matsu/final_draw/zone_construction_time/difference/cdf_log_difference.png')
plt.show()
