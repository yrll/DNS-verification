...
# 设置文件夹路径
file_path = '/home/matsu/final_v1.1/symbolic_and_checking/difference.csv'
...
plt.xlabel('CDF of Symbolic Execution Difference Time(ms)', fontsize=24, fontweight='bold')
...
# 保存图像
plt.tight_layout()
plt.savefig('/home/matsu/final_draw/zone_symbolic_time/difference/cdf_log_difference.png')
plt.show()
