...
file_path_matsu_cttime = '/home/matsu/final_v1.1/Matsu_cttime/Matsu_cttime.csv'
...
mttime = merged_df['construction time (ms)'].dropna()
grtime = merged_df['Graph building (s)'].dropna()
...
print(f"matsu time: {max_matsu_row['construction time (ms)']} ms")
print(f"groot time: {max_matsu_row['Graph building (s)']} ms")
...
# 设置标题和轴标签，字体较大且加粗
plt.title(' Scatter of RRs Per Zone vs. Construction Time', fontsize=22, fontweight='bold')
plt.xlabel('Number of RRs Per Zone', fontsize=28, fontweight='bold')
plt.ylabel('Construction Time (ms)', fontsize=28, fontweight='bold')
...
# 保存图像
plt.savefig('/home/matsu/final_draw/zone_rr_vs._cttime_scatter/matsuandgroot_all_log.png')
