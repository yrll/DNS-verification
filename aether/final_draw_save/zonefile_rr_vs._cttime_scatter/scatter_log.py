...
# 设置标题和轴标签，字体较大且加粗
plt.title(' Scatter of RRs Per Zonefile vs. Construction Time', fontsize=22, fontweight='bold')
...
# 保存图像
plt.savefig('/home/matsu/final_draw/zonefile_rr_vs._cttime_scatter/matsuandgroot_log.png')
